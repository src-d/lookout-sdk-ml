...
lookout-sdk-ml project is [Affero GPL licensed](../LICENSE.md) and accepts contributions via GitHub pull requests. This document outlines some of the conventions on development workflow, commit message formatting, contact points, and other resources to make it easier to get your contribution accepted.
...
* GitHub [issues](https://github.com/src-d/lookout-sdk-ml/issues)\*
...
Pull Requests \(PRs\) are the main and exclusive way to contribute to the official lookout-sdk-ml project. In order for a PR to be accepted it needs to pass a list of requirements:

* Code Coverage does not decrease.
* All the tests pass (`make test` or `make docker-test`).
